...
### 1.8.89
#### 新增
- 内置音源扩充至 10 个：野草、野花、sixyin、小熊猫、梓澄、Huibq、ikun公益、ikun香港、無名、肥猫不肥
- 首次启动无音源时自动导入全部内置音源
---
### 1.8.88
#### 新增
- 全新 AI 助手界面：紫蓝渐变动画顶部、毛玻璃头像气泡、工具执行卡片、录音波纹动画
- 听歌识曲功能（Shazam）：录音 5 秒识别周围音乐，识别后一键播放
- AI 工具新增 shazam 听歌识曲
#### 修复
- AI 播放控制：修复"提示播放但实际未播放"的问题，强制触发 playNext + play
---
### 1.8.85
#### 修复、优化
- 同步上游代码
